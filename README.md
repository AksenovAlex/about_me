...
+ [Программа для расчета гидравлических расчетов](https://github.com/AksenovAlex/Hydraulic-calculation)
Графическое приложение, выполненное с использованием
фреймворка Tkinter

+ [Сайт кондитерской по онлайн заказу еды](https://github.com/AksenovAlex/Hydraulic-calculation)
Backend выполнен с применением фреймворка Django.
Frontend выполнен собственноручно (без использования готовых шаблонов)
с применением HTML5, CSS3, JS/jQuery
